...
<head>
    ...
    <link rel="stylesheet" href="assets/css/bootstrap/css/mdb-pro.min.css">
    <!-- Material Design Bootstrap Ecommerce -->
    <link rel="stylesheet" href="assets/css/bootstrap/css/mdb.ecommerce.min.css">
        ...
        <section class="mb-5">
            ...
            <div class="row">
                            ...
                            <div class="col-12 mb-0">
                                <figure class="view overlay rounded z-depth-1 main-img" style="max-height: 450px;">
                                    <a href="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/15a.jpg"
                                       data-size="710x823">
                                        <img src="https://cdn.shopify.com/s/files/1/2784/4648/products/Rose_Gold_Transparent_With_Shadow_1140x1140.png?v=1607187036"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="view overlay rounded z-depth-1 gallery-item hoverable">
                                            <img src="https://d4yxl4pe8dqlj.cloudfront.net/images/6606fb02-6893-4a7e-acb2-7184c36e3428/6e0df1b8-37ea-4291-8ff0-e6e4f5c9102e_large.jpg"
                                                 class="img-fluid">
                                    ...
                                    <div class="col-3">
                                        <div class="view overlay rounded z-depth-1 gallery-item hoverable">
                                            <img src="https://d4yxl4pe8dqlj.cloudfront.net/images/6606fb02-6893-4a7e-acb2-7184c36e3428/13ca7eea-b70c-4bbf-bbb1-e7016a74c17e_large.jpg"
                                                 class="img-fluid">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <h5>PRAGUE SKELETON AUTOMATIC - ROSE GOLD</h5>
                    <p class="mb-2 text-muted text-uppercase small">Watch</p>
                    <ul class="rating">
                        <li>
                    ...
                    <button type="button" class="btn btn-primary btn-md mr-1 mb-2">Contact Founder</button>
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                    ...
                    <div class="media mt-3 mb-4">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0">That's mine . Thank you for posting</p>
                        </div>
                    </div>
                    <hr>
                ...
                <div class="col-md-6 col-lg-3 mb-5">
                    ...
                    <div class="">
                        ...
                        <div class="view zoom overlay z-depth-2 rounded">
                            ...
                            <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news">Important</span></h4>
                            <a href="#!">
                                <div class="mask">
                                    <img class="img-fluid w-100"
