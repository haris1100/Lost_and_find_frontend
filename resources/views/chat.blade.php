...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns">
 ...
 @php 
              ...
              $getChats=\App\Http\Controllers\usersControl::getChats();
              //$getChats
                     $getChats=json_decode($getChats,true);
              //   print_r($getChats['chats'][0]['message']);
               //  echo $getChats[0];
            @endphp
            <style>
                .container {
...
.time-left {
  ...
  color: #999;
                ...
                @foreach($getChats['chats'] as $key=>$chat)
                <div class="container">
      <p>{{$chat['message']}}</p>
                                                ...
                                                <ul class="tabs">
                                                    <li class="tab col s4 p-0">
                                                        <a href="#messages" class="active">
                                                            <span class="center">Messages</span>
                                                        </a>
                                                    </li>
