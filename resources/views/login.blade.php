@if(session()->get('url'))
<script>
   sessionStorage.setItem('redirectionURL','{{session()->get("url")}}')</script>
    @endif
<!DOCTYPE html>
<html lang="en">

<head>
    <title>National Lost And Found Repository </title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form class="md-float-material form-material login-me-as-user" >
                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="form-group form-primary">
                                ...
                                <label class="float-label">Your Email Address/Username/CNIC</label>
                            </div>
                            ...
                            <div class="row m-t-25 text-left">
                                <div class="col-12">
                                    ...
                                    <div class="forgot-phone text-right f-right">
                                        <a href="forget-password" class="text-right f-w-600"> Forgot Password?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20 btn-to-rotate">Sign in</button>
                                </div>
                            </div>
                            <p class="text-left m-b-0 login-message"></p>
                            <hr/>
                            <div class="row">
                                <div class="col-md-10">
